...
class Graph:
    ...
    def __init__(self, vertices, node_names):
        ...
        self.add_edge("Beirut", "Tripoli", 1)
        self.add_edge("Beirut", "Sidon", 1)
        self.add_edge("Beirut", "Anout", 4)
        self.add_edge("Beirut", "Barja", 3)
        self.add_edge("Beirut", "Hemmana", 2)
        self.add_edge("Beirut", "Zahla", 2)
        self.add_edge("Beirut", "Aley", 1)
        self.add_edge("Beirut", "Baabda", 1)

        self.add_edge("Tripoli", "Akkar", 1)
        self.add_edge("Tripoli", "Jezzine", 1)
        self.add_edge("Tripoli", "Zahla", 2)
        self.add_edge("Tripoli", "Rashaya", 2)

        self.add_edge("Anout", "Barja", 2)
        self.add_edge("Anout", "Sidon", 1)
        self.add_edge("Anout", "Bet ed Dine", 2)
        self.add_edge("Anout", "Aley", 3)
        self.add_edge("Anout", "Rashaya", 3)

        self.add_edge("Baabda", "Anout", 2)
        self.add_edge("Baabda", "Sidon", 1)
        self.add_edge("Baabda", "Aley", 1)
        self.add_edge("Baabda", "Hemmana", 1)
        self.add_edge("Baabda", "Bet ed Dine", 2)

        self.add_edge("Rashaya", "Tripoli", 2)
        self.add_edge("Rashaya", "Jezzine", 2)
        self.add_edge("Rashaya", "Zahla", 1)
        self.add_edge("Rashaya", "Anout", 3)

        self.add_edge("Sidon", "Naqoura", 1)
        self.add_edge("Sidon", "Beirut", 1)
        self.add_edge("Sidon", "Barja", 1)
        self.add_edge("Sidon", "Anout", 2)
        self.add_edge("Sidon", "Aley", 3)
        self.add_edge("Sidon", "Rashaya", 2)

        self.add_edge("Bet ed Dine", "Beirut", 1)
        self.add_edge("Bet ed Dine", "Aley", 1)
